...
def calculate_required_pods(current_pods, historical_data, max_replicas, prediction_window_minutes=2):
...
def create_fn(spec, name, namespace, logger, **kwargs):
    ...
    def recurring_update():
        ...
        try: 
            ...
            prediction_window_minutes = spec.get('predictionWindowMinutes', 2)
